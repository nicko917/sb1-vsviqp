    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
      ...
      <main className="container mx-auto px-4 py-8">
        <section className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">Bienvenido a la nostalgia gaming</h2>
          <p className="text-xl text-white mb-6">Descubre nuestra colección de consolas y juegos retro</p>
          <Button asChild>
            <Link href="/tienda">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {['NES', 'SNES', 'PlayStation'].map((console) => (
            <div key={console} className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">{console}</h3>
              <p className="mb-4 text-gray-600">Revive los clásicos con nuestra selección de juegos para {console}.</p>
